            ...
            return (
              <div key={index} className="flex flex-col sm:flex-row sm:items-start space-y-4 sm:space-y-0 sm:space-x-6 group">
                <div className="flex-shrink-0 flex justify-center sm:justify-start">
                  <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-r from-yellow-500 to-green-500 rounded-xl sm:rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                ...
                <div className="flex-1 text-center sm:text-left">
                  <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-3 mb-3">
                    ...
                    <span className="bg-gradient-to-r from-yellow-500 to-green-500 text-white px-3 py-1 rounded-full text-xs sm:text-sm font-semibold">
                      {t(reason.statsKey)}
                    </span>
                  </div>
