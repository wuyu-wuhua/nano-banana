...
const FloatingSupport: React.FC = () => {
  ...
  const handleEmailClick = (e: React.MouseEvent) => {
    ...
    try {
      const url = 'https://mail.google.com/mail/u/0/#inbox?compose=DmwnWrRttWThJBQFSZSZtbVMNjVPPdvbDNkhFBVxDkvhfDgjrbDqMbLvsBFkJpMWVhKZhnfmtNlG';
      ...
      // 备用方案：直接跳转
      window.location.href = 'https://mail.google.com/mail/u/0/#inbox?compose=DmwnWrRttWThJBQFSZSZtbVMNjVPPdvbDNkhFBVxDkvhfDgjrbDqMbLvsBFkJpMWVhKZhnfmtNlG';
    }
  };
