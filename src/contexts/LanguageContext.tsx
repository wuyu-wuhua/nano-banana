...
const translations = {
  ...
  'zh-tw': {
    ...
    hero: {
      title: '將你的想法轉化為驚豔的AI公仔| 專業3D公仔創作平台',
      subtitle: '使用我們先進的AI公仔生成技術，在幾秒鐘內創作出美麗、獨特的3D公仔模型。Nano Banana是專業的AI公仔生成器，支援多種公仔風格創作。',
      cta: '立即開始AI公仔創作',
      learnMore: '了解更多公仔創作技巧',
      examplePrompt: '粉色頭髮的可愛動漫女孩AI公仔 ',
    },
    what: {
      title: '什麼是Nano Banana AI公仔生成器？',
      subtitle: 'Nano Banana是專業的AI公仔創作平台，將你的文字描述轉化為驚豔的3D公仔模型。我們的AI公仔生成器支援多種公仔風格，是創作者的首選公仔製作工具。',
      feature1: {
        title: 'AI公仔驅動生成',
    ...
    how: {
      ...
      step2: {
        title: '選擇你的 AI公仔風格',
        desc: '選擇各種 AI公仔風格，如動漫公仔、寫實公仔、Q版公仔等。我們的AI公仔生成器支援多種公仔風格',
      },
      step3: {
        title: '下載你的 AI公仔模型',
    ...
    faq: {
      ...
      q4: '生成的AI公仔3D模型品質如何？',
      a4: '免費用戶獲得標準品質的AI公仔模型。高級用戶可以生成高細節 AI公仔模型，完美適用於3D列印、遊戲和專業用途。每個AI公仔都經過精心優化。',
      q5: '我可以商業使用生成的AI公仔嗎？',
      a5: '是的！所有使用Nano Banana AI公仔生成器生成的公仔都可以用於商業目的。你擁有 AI公仔創作的完全權利，包括銷售、修改和分發AI公仔的權利。',
      q6: '生成AI公仔需要多長時間？',
      a6: '大多數AI公仔在15-30秒內生成。高級用戶享受優先處理，在高峰時段可以將 AI公仔生成時間縮短到僅10秒。讓AI公仔創作變得高效便捷。',
      q7: 'Nano Banana AI公仔生成器與其他AI生成器有什麼不同？',
      a7: 'Nano Banana AI公仔生成器專注於3D公仔生成，注重 AI公仔品質、速度和用戶體驗。我們使用最新的AI公仔模型，提供比競爭對手更多的公仔風格，提供更好的AI公仔提示詞理解，並保持業界最高的3D公仔模型品質標準。',
      q8: '我的 AI公仔資料安全私密嗎？',
      a8: '絕對安全。我們認真對待 AI公仔隱私。你的 AI公仔提示詞和生成的3D公仔模型都經過加密，絕不會與第三方共享。你可以隨時刪除你的帳戶和所有相關AI公仔資料。',
    },
    footer: {
