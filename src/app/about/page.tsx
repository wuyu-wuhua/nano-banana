        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">{t('about.value1.title')}</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">{t('about.value2.title')}</h4>
              <p className="text-gray-600 text-sm">
                {t('about.value2.desc')}
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">{t('about.value3.title')}</h4>
              <p className="text-gray-600 text-sm">
                {t('about.value3.desc')}
              </p>
            </div>
